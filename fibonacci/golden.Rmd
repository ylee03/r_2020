...
golden_spiral_hidden(n = 10, drawArc = FALSE, label = TRUE)
points(0, 0, pch = 16)
```
...
```{r prompt = TRUE, fig.cap = "Six spirals with boxes", fig.width = 13, fig.height = 8}
golden_spiral (n = 6, rect = TRUE, label = TRUE) #
```

그리고 설명하지 않았지만 drawArc 옵션을 끄면 알아서 상자만 그린다.

```{r prompt = TRUE, fig.cap = "Eight boxes without spirals", fig.width = 13, fig.height = 8}
